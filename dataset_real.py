...
par_dict = {'General_val_test': {'n_ratio': 1,
            ...
            'Lgbm': {"num_leaves": [5],
                     ...
                     "sample_subsample_undersample": [[0.5, None],[0.75, None]],  #undersample not yet implemented
                     "subsample_freq": [1],
                     "min_child_samples": [0],
...
par_dict["Logit"]["metric"] = ['roc_auc'] # basic, arp, roc_auc, ap, dcg, ep, precision
par_dict["Logit"]["n_ratio"] = [1]
par_dict["Logit"]["p_ep"] = [1/2]

par_dict["Lgbm"]["metric"] = ['roc_auc'] # basic, arp, roc_auc, ap, dcg, ep, precision
par_dict["Lgbm"]["n_ratio"] = [1]
par_dict["Lgbm"]["p_ep"] = [1/2]
...
# name = 'ep_financial_misconduct_1_2_out'
