...
def informativeness_plotter_2(target_metric, original_metric, actual_target_metric_value_array, inferred_target_metric_value_array,
                            tau):
    ...
    ax.plot([0, 1], [0, 1], transform=ax.transAxes)
    ax.set(aspect="equal", xlim=(0, 1), ylim=(0, 1),
           xlabel='Cost-sensitive '+target_metric, ylabel='Basic '+target_metric)
    ax.text(0.05, 0.95, str(tau))
